...
class EzadminCrawlerConfig(ProgramConfig):
    config_name = "ezadmin_crawler"
    ...
    def init_data(self):
        # 저장데이터 없는 경우 초기화
        member_datas = EzadminCrawlerData().__member__()
    ...
    def data_to_dict(self, data: EzadminCrawlerData) -> dict:
    ...
    def dict_to_data(self, data: dict) -> EzadminCrawlerData:
        newData = EzadminCrawlerData()
...
if __name__ == "__main__":
    addData = EzadminCrawlerData()
    EzadminCrawlerConfig = EzadminCrawlerConfig()
    dict_data = EzadminCrawlerConfig.data_to_dict(addData)
    print(dict_data)
