...
from tabs.ezadmin_crawler_tab import EzadminCrawlerTab
...
# pyinstaller -n "ezadmin v0.0.9 (판매처별정산통계 화면 일부 변경)" -w --onefile --clean "main.py" --icon "assets\ezadmin.ico"
...
class MainUI(QWidget):
    ...
    def initUI(self):
        ...
        # 탭 초기화
        self.ezadmin_crawler_tab = EzadminCrawlerTab()

        # 탭 추가
        tabs = QTabWidget()
        tabs.addTab(self.ezadmin_crawler_tab, "매출분석")
        ...
        # 앱 기본 설정
        self.setWindowTitle(f"ezadmin v0.0.9")
        self.resize(600, 900)
        self.center()
        self.show()
